...
public class PSO extends Algorithm {
	...
	public PSO(Individual bestIndividual) {
		...
		//by default: global neighborhood
		/**
		 * Better results by global neighborhood.
		 * @author Karlo Knezevic, karlo.knezevic@fer.hr
		 */
		globalNeighborhoodSet = true;
	...
	private void initialize() {
		...
		Particle bestPreviousIndividual = this.initialIndividual!=null ?
				new Particle(this.initialIndividual.getPersonWorkLists()) : null;
